...
import 'package:mentorx_mvp/screens/program_guides/program_guide_data/program_guides_track4/graduatedegrees_401/graduatedegrees_401.dart';
import 'package:mentorx_mvp/screens/program_guides/program_guide_data/program_guides_track4/payingitforward_401/payingitforward_401.dart';
                    ...
                    onTap: () {
                      (guideStatus.emotionalIntelligenceStatus == null)
                          ...
                          : Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    EmotionalIntelligence401Screen(
                                  loggedInUser: widget.loggedInUser,
                                  matchID: widget.matchID,
                                  mentorUID: widget.mentorUID,
                                  programUID: widget.programUID,
                    ...
                    onTap: () {
                      (guideStatus.graduateDegrees == null)
                          ...
                          : Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => GraduateDegrees401Screen(
                                  loggedInUser: widget.loggedInUser,
                                  matchID: widget.matchID,
                                  mentorUID: widget.mentorUID,
                                  programUID: widget.programUID,
                    ...
                    onTap: () {
                      (guideStatus.payingItForward == null)
                          ...
                          : Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => PayingItForward401Screen(
                                  loggedInUser: widget.loggedInUser,
                                  matchID: widget.matchID,
                                  mentorUID: widget.mentorUID,
                                  programUID: widget.programUID,
